    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 object-cover rounded-[15px] border border-white/10 shadow-2xl will-change-transform [transform:translateZ(0)]"
          style={{
            width: imageWidth,
            height: imageHeight
          }}
      ...
      {showTooltip && captionText && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-black border border-white/20 px-[10px] py-[4px] text-[10px] text-white shadow-lg opacity-0 z-[3] hidden sm:block whitespace-nowrap"
          style={{
            x,
            y,
            opacity,
